...
export default function Experience({ navigationMenuItems, parsedData = [] }) {
  ...
  const {
    loading: otherExperiencesLoading,
    error: otherExperiencesError,
    ...
    <Layout navigationMenuItems={navigationMenuItems}>
      ...
      <div ref={experienceTop01} id="experience-top-01">
        {Boolean(parsedData.length) &&
          ReactHtmlParser(
            parsedData.find((fold) => fold.id === "experience-top-01")?.content
          )}
      </div>
      <StyledWrapper
      ...
      >
        <Wrapper>
          ...
          <Flex
            ...
            padding="0 40px"
          >
            <h1 className="exp-heading">{experienceInfo?.experience?.title}</h1>
            {width > 769 && (
          ...
          >
            ...
            <Flex container alignItems="center" justifyContent="space-between">
              ...
              <span className="duration">
                {moment
                  .duration(
                    experienceInfo?.experience?.experienceClasses[0]?.duration
                  )
                  .asMinutes()}
                min
              </span>
                          ...
                          return (
                            <li key={header.id}>
                              <a href={`#${header.id}`}>
                                <a
                                  className={
                                    router.asPath.includes(`#${header.id}`) &&
                                    "activeHash"
                                  }
                                >
                                  {header?.title}
          ...
          <div className="info-wrapper">
            <div className="left-container">
              <section id="section-1">
                ...
                <ReadMoreDiv>
                  <p className="about-exp">
                    {parse(experienceInfo?.experience?.description || "")}
                  </p>
                </ReadMoreDiv>
              </section>
              {!isEmpty(
                ...
                <section id="section-2">
                  ...
                  <AboutExpert
                    ...
                    expertCategory={experienceInfo?.experienceCategoryTitle}
                  />
                </section>
              )}
              <div id="section-3">
              ...
              <div id="section-4">
                <Goodies products={products} title="Goodies in your Kit" />
              </div>

              {experienceInfo?.experience?.experience_headers.map((header) => {
                return (
                  <section id={header.id}>
                    <h1 className="sub-heading">{header?.title}</h1>
