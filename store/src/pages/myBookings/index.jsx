    ...
    <Layout navigationMenuItems={navigationMenuItems}>
      ...
      <div id="myBookings-top-01">
        {Boolean(parsedData.length) &&
          ReactHtmlParser(
            parsedData.find((fold) => fold.id === "myBookings-top-01")?.content
          )}
      </div>
      <Wrapper>
        {bookings.length > 0 ? (
                    ...
                    <Flex flexDirection="column" container flex="1">
                      ...
                      >
                        <Flex
                          ...
                          alignItems="center"
                        >
                          {booking?.experienceInfo?.experienceClassExpert
                            ?.assets &&
                            booking?.experienceInfo?.experienceClassExpert
                        ...
                        <span className="duration">
                          ...
                          />
                          <span>
                            {getMinute(booking?.experienceInfo?.duration)}
                            min
                          </span>
                        </span>
                      </Flex>
