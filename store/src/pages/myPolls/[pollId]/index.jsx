...
export default function MyBooking({ navigationMenuItems, parsedData = [] }) {
  ...
  if (loading || isLoading) return <InlineLoader />;
    ...
    <Layout navigationMenuItems={navigationMenuItems}>
      ...
      <Wrapper>
        <div className="checkout-heading">
          <span className="back-button" onClick={() => router.push(`/myPolls`)}>
      ...
      <div id="myPoll-bottom-01">
        {Boolean(parsedData.length) &&
          ReactHtmlParser(
            parsedData.find((fold) => fold.id === "myPoll-bottom-01")?.content
          )}
      </div>
    </Layout>
  );
    ...
    <CardWrapper>
      ...
      <div className="price-details">
        ...
        <div className="pricing">
          ...
          <p>
            {getDateWithTime(mostVotedOption?.experienceClass?.startTimeStamp)}{" "}
