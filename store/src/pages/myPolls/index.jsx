  ...
  return (
    <Layout navigationMenuItems={navigationMenuItems}>
                    ...
                    <Flex flexDirection="column" container flex="1">
                      ...
                      >
                        ...
                        >
                          <div className="expertImgDiv">
                            <img
                              ...
                              src={
                                poll?.experienceInfo?.experienceClassExpert
                                  ?.assets?.images[0]
                              }
                              alt="expert-img"
                            />
                        ...
                        <span className="duration">
                          ...
                          />
                          <span>
                            {getMinute(poll?.experienceInfo?.duration)}
                            min
                          </span>
                        </span>
                      </Flex>
                      ...
                      >
                        ...
                        <p className="exp-info">{poll?.bookingOptionsCount}</p>
                      </Flex>
                      <Flex
                        container
                        alignItems="center"
                      ...
                      >
                        ...
                        <p className="exp-info">
                          ...
                          {poll?.mostVotedOption?.voting?.aggregate?.count}{" "}
                          votes)
                        </p>
                      </Flex>
      ...
      <div id="myPolls-bottom-01">
        {Boolean(parsedData.length) &&
          ReactHtmlParser(
            parsedData.find((fold) => fold.id === "myPolls-bottom-01")?.content
          )}
      </div>
    </Layout>
  );
