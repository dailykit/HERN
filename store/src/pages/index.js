...
import { useAuth, useCustomWebpageModuleQuery } from "../Providers";
...
export default function Home({ navigationMenuItems = [], parsedData = [] }) {
  ...
  const {
    loading: expertByCategoryLoading,
    error: expertByCategoryError,
    ...
    <Layout navigationMenuItems={navigationMenuItems}>
      ...
      <StyledWrapper>
            ...
            {isAuthenticated ? (
              <>
                ...
                <p className="greeting-msg">
                  Check out these experiences we handpicked for you. You can
                  also manage your booked events below.
                </p>
              </>
            ) : (
              <>
                <h1 className="greeting-name">Welcome to StayInSocial</h1>
                <p className="greeting-msg">
            ...
            !isEmpty(customerSelectedTags[0]?.tags) && (
              <CategorySection>
                <Flex
                  ...
                  padding="1rem 0"
                >
                  <h3 className="experienceHeading">Your personalized tags</h3>
                </Flex>
                <CategoryTagWrap>
        ...
        <div ref={homeBottom01} id="home-bottom-01">
          {Boolean(parsedData.length) &&
            ReactHtmlParser(
              parsedData.find((fold) => fold.id === "home-bottom-01")?.content
            )}
        </div>
      </StyledWrapper>
    </Layout>
