        ...
        if (
                ...
                return {
                  ...
                  childCart: {
                    data: {
                      ...
                      parentCartId: createExperienceBooking?.parentCart?.id,
                    },
                  },
          ...
          await CART.updateMany.mutation({
            variables: {
              ...
              _set: {
                experienceClassId: experienceBookingDetails?.experienceClassId,
          ...
          if (!CART_ITEM.createMany.loading) {
            router.push(`/checkout?cartId=${experienceBookingDetails?.cartId}`);
          }
        }
      }
      if (!isEmpty(cart)) {
