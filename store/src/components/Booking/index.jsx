  ...
  useEffect(() => {
    if (!isEmpty(cartInfo) && !isEmpty(experienceInfo?.experienceClasses)) {
      (async () => {
        ...
        const selectedClassTypeInfo = experienceInfo?.experienceClasses.find(
        ...
        await updateExperienceInfo({
          ...
          priceBreakDown: selectedClassTypeInfo?.classTypeInfo?.priceRanges,
        ...
        const productOption = productCartItems[0]?.product?.productOptions.find(
