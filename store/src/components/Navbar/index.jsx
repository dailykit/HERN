  ...
  return (
    <>
      ...
      <FloatingCartButton
        ...
        toggleFloatingButton={() => SetIsFloatingButtonVisible((prev) => !prev)}
      ...
      <NavBar cartCount={carts.lenth}>
        ...
        <li className="nav-list-item">
          <NavLink href="/experts">
            <a className={pathname === "/experts" && "activeLink"}>Experts</a>
          </NavLink>
        </li>
        ...
        <SignupModalContainer isShow={isSignupShow}>
          <Modal isOpen={isSignupShow} close={hideSignup} type="sideDrawer">
