...
const AddApiKeyTunnel = (props)=>{
    ...
    const reducers = (state, { type, payload }) => {
        switch (type) {
            ...
            case 'SET_ADD_PRODUCT':
                return {
                    ...state,
                    canAddProduct:payload
                }
            case 'SET_UPDATE_PRODUCT':
                return {
                    ...state,
                    canUpdateProduct:payload
                }
        }   
    }
    ...
    const submitForm = ()=>{
        addApiKey({
            variables:{
                "canUpdateProducts": state.canAddProduct,
                "canAddProducts": state.canAddProduct,
             ...
             <Tunnels tunnels={props.tunnels}>
                    ...
                    <Spacer size="15px" />
                            ...
                            <Form.Group>
                                 <Form.Toggle
                                    name='addProduct'
                                    onChange={e => dispatch({type:'SET_ADD_PRODUCT', payload: !state.canAddProduct})}
                                    value={state.canAddProduct}
                                    size={40}
                                >
                                    Add products
                                </Form.Toggle>
                            ...
                            <Form.Group>
                                 <Form.Toggle
                                    name='updateProduct'
                                    onChange={e => dispatch({type:'SET_UPDATE_PRODUCT', payload: !state.canUpdateProduct})}
                                    value={state.canUpdateProduct}
                                    size={40}
                                >
                                    Update products
                                </Form.Toggle>
...
export default AddApiKeyTunnel