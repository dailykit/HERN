...
const ActionBar = props => {
   ...
   const downloadCsvData = () => {
      tableRef.current.table.download('csv', `packaging-${type}.csv`)
   }

   const downloadPdfData = () => {
      tableRef.current.table.downloadToTab('pdf', `packaging-${type}.pdf`)
   }

   const downloadXlsxData = () => {
      tableRef.current.table.download('xlsx', `packaging-${type}.xlsx`)
   }
   return (
      <>
