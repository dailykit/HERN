...
export const RegisterPage = ({ update }) => {
   ...
   const { loading, error } = useSubscription(BRANDS.SETTING, {
      variables: {
         identifier: { _eq: 'register-background' },
         type: { _eq: 'Register' },
      },
      onSubscriptionData: ({
      ...
      <div id="register-background">
         ...
         <Tunnels tunnels={tunnels}>
            <Tunnel layer={1} size="md">
               ...
               <Banner id="brands-app-brands-brand-details-subscription-settings-register-page-bg-tunnel-top" />
               <Flex padding="16px">
                  <AssetUploader
                     onAssetUpload={data =>
               ...
               <Banner id="brands-app-brands-brand-details-subscription-settings-register-page-bg-tunnel-bottom" />
            </Tunnel>
         </Tunnels>
      </div>
   )
