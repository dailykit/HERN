...
const ConfigUI = ({ config, configSaveHandler, identifier, isChangeSaved, setIsSavedChange, noneditMode, setLinkedModuleId, setMode, mode, saveAllSettings, setSaveAllSettings, updateAllSettings, setting_brand_Id }) => {
