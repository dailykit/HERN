...
import { Tooltip } from '../..'
import { CUISINES_NAMES } from '../subscription'
import { CREATE_CUISINE_NAME } from '../mutation'

export const RecipeBulkAction = props => {
   // props
   const {
      initialBulkAction,
                  ...
                  <HorizontalTabPanel>
                     <Form.Group>
                        ...
                        <Form.Text
                           ...
                           value={initialBulkAction.descriptionConcat.forAppend}
                           onChange={e =>
                              setInitialBulkAction({
                                 ...initialBulkAction,
                                 descriptionConcat: {
                     ...
                     >
                        ...
                        <ButtonGroup align="left">
                           <TextButton
                              type="solid"
                              size="sm"
                              disabled={initialBulkAction.description == null}
                              onClick={() => {
                                 setInitialBulkAction(prevState => ({
                                    ...prevState,
                                    description: null,
               ...
               <HorizontalTabList>
                  ...
                  <HorizontalTab>
                     <TextButton
                        type="ghost"
                        size="sm"
                        disabled={isSetNullVisible('notIncluded', 'concatData')}
                        onClick={() => {}}
                     >
                        Set Null
                     </TextButton>
                  ...
                  <HorizontalTabPanel>
                     <Form.Group>
                        ...
                        <Form.Text
                           ...
                           value={initialBulkAction.notIncludedConcat.forAppend}
                           onChange={e =>
                              setInitialBulkAction({
                                 ...initialBulkAction,
                                 notIncludedConcat: {
                     ...
                     <Form.Group>
                        ...
                        >
                           <Flex container alignItems="center">
                              <Text as="text1">Prepend what you'll need</Text>
                              <TextButton
                                 type="ghost"
                                 size="sm"
                                 onClick={() => {
                     ...
                     >
                        ...
                        <ButtonGroup align="left">
                           <TextButton
                              type="solid"
                              size="sm"
                              disabled={initialBulkAction.notIncluded == null}
                              onClick={() => {
                                 setInitialBulkAction(prevState => ({
                                    ...prevState,
                                    notIncluded: null,
